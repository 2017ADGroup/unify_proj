...
/**
 * Servlet implementation class RoomInfoInsertConfirm
 */
@WebServlet("/RoomInfoInsertConfirm")
public class RoomInfoInsertConfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public RoomInfoInsertConfirmServlet() {
        super();
