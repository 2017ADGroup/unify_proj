...
<<<<<<< HEAD:accountInsert.html
=======

>>>>>>> develop:superuser/adminInsert.html
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
<form class="form-hrizonatal" method="POST" action="adminInsert.html" name="form1" onSubmit="return check()">
