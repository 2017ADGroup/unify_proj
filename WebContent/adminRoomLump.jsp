...
<body>
	...
	<fieldset>
		<table class="table">
			...
			<tbody>
				<tr>
					<td><input type='date' name='date' value='2017-07-07'
						disabled='disabled'></td>
					<td><input type="text" name="login_id" value='o003'
						disabled='disabled'></td>
					<td>
						<p>
					...
					<td><input type="text" name="fixtures" value='プロジェクター'>
						<input type="text" name="fixtures" value='スピーカー'> <input
						type="text" name="fixtures" value='マイク'> <input
						type="text" name="fixtures"> <input type="text"
						name="fixtures"> <input type="text" name="fixtures">
					</td>
					<td><textarea name="bikou" rows="5" cols="32">部活動のため一部机を移動します。</textarea></td>
					<td><input name="reserveDelete" type="checkbox" value="1" /><input
						type="hidden" name="delete" value="on" /></td>
				</tr>
				<tr>
					<td><input type='date' name='date' value='2017-07-08'
						disabled='disabled'></td>
					<td><input type="text" name="login_id" value='00e0003'
						disabled='disabled'></td>
					<td>
						<p>
							<select disabled='disabled'>
					...
					<td>
						...
						</p> <input name="ninnzuu" type="number" value="75">
					</td>
					<td><input type="text" name="fixtures" value='プロジェクター'>
						<input type="text" name="fixtures" value='スピーカー'> <input
						type="text" name="fixtures"> <input type="text"
						name="fixtures"> <input type="text" name="fixtures">
						<input type="text" name="fixtures"></td>
				...
				<tr>
					<td><input type='date' name='date' value='2017-07-08'
						disabled='disabled'></td>
					<td><input type="text" name="login_id" value='00h0023'
						disabled='disabled'></td>
					<td>
						<p>
							<select disabled='disabled'>
					...
					<td>
						...
						</p> <input name="ninnzuu" type="number" value="100">
					</td>
					<td><input type="text" name="fixtures" value='プロジェクター'>
						<input type="text" name="fixtures" value='スピーカー'> <input
						type="text" name="fixtures"> <input type="text"
	...
	<form class="form-hrizonatal" method="POST" action="adminRoomLump.html"
